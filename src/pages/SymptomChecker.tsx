          ...
          <div className="bg-slate-800/50 backdrop-blur-xl rounded-xl border border-cyan-500/20 shadow-2xl shadow-cyan-500/10 p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div>
                ...
                <ConditionsPieChart assessment={assessment} />
              </div>
              <div>
                <h4 className="text-cyan-400 font-semibold mb-2">
                  Urgency Score
                </h4>
                <UrgencyBarChart assessment={assessment} />
              </div>
            </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  {assessment.possible_conditions.map((condition, index) => (
                    <div
                      key={index}
                      className="border border-cyan-500/20 bg-slate-700/30 rounded-lg p-4 hover:border-cyan-500/40 transition-colors"
                    >
                      <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Powered by advanced AI for accurate health insights
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="space-y-6 animate-fade-in">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    onClick={() => setStep(3)}
                    disabled={
                      !formData.age || !formData.gender || !formData.duration
                    }
            ...
            {step === 3 && (
              <div className="space-y-6 animate-fade-in">
                  ...
                  <div className="flex flex-col items-center mb-6">
                    ...
                    >
                      <div className="flex flex-col items-center">
                        <div
                          className={`w-20 h-20 rounded-full flex items-center justify-center transition-all duration-300 mb-3 shadow-lg ${
                            formData.severity <= 3
                ...
                {formData.severity >= 7 && (
                  <div
                    className={`border rounded-lg p-4 animate-fade-in transition-all duration-300 ${
                      formData.severity >= 9
